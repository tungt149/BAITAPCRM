...
<body class="layout-login">
    ...
    <div class="layout-login__form bg-white" data-perfect-scrollbar>
        <div class="d-flex justify-content-center mt-2 mb-5 navbar-light">
            <a href="<%=request.getContextPath() + urlUtil.URL_LOGIN%>" class="navbar-brand" style="min-width: 0">
        ...
        <form action="<%=request.getContextPath() + urlUtil.URL_DASHBOARD%>" novalidate>
            ...
            <div class="form-group text-center">
               <a href="<%=request.getContextPath() + urlUtil.URL_DASHBOARD%>">  <button class="btn btn-primary mb-5" type="submit">Login</button> </a><br> 
                <a href="">Forgot password?</a> <br> Don't have an account? <a class="text-body text-underline" href="<%=request.getContextPath() + urlUtil.URL_DASHBOARD%>">Sign up!</a>
            </div>
        </form>
    </div>
